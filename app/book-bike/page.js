...
export default function BookZineBike() {
  return (
    <div className="py-8 px-2 sm:px-0">
      ...
      <div className="w-screen relative left-1/2 -translate-x-1/2 grid grid-cols-1 sm:grid-cols-2 gap-3 mb-2">
        {/* Left column — portrait, full height */}
        <div className="flex flex-col order-2 sm:order-1">
          <div className="relative aspect-[2/3] sm:aspect-auto sm:flex-1 rounded overflow-hidden">
            <Image
              src="/MF-DSCF6391.jpg"
              alt="Book bike"
              fill
        ...
        <div className="flex flex-col gap-3 order-1 sm:order-2">
          <div>
            <div className="rounded overflow-hidden">
              <Image
                src="/lucas-mckinnon-got-craft-zine-bike.jpeg"
                alt="Book bike"
                width={1600}
                height={1067}
                sizes="(min-width: 640px) 50vw, 100vw"
          ...
          <div>
            <div className="rounded overflow-hidden">
              <Image
                src="/lucas-mckinnon-zine-bike-2.jpeg"
                alt="Book bike"
                width={1600}
                height={1067}
                sizes="(min-width: 640px) 50vw, 100vw"
            ...
            <p className="text-xs text-zinc-400 dark:text-zinc-500 italic mt-1 px-1">Got Craft Holiday Market, Vancouver. <br/>Photo credit: <a href="https://lucasmckinnon.art/" target="_blank" rel="noopener noreferrer" className="text-teal-500 hover:text-teal-400 transition-colors">Lucas McKinnon</a></p>
          </div>
        </div>
      </div>
      <div className="mb-12" />
